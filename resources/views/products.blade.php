...
<head>
    ...
    <title>Products | Discover Mansalay</title>
...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('products.public') }}" style="color: var(--pink-600); font-weight: 600;">Products</a>
    ...
    <section class="destinations">
        <div class="destinations-container">
            ...
            <div class="section-header">
                ...
                <h2 class="section-title">Discover Local Crafts & Goods</h2>
            </div>
                    ...
                    @php
                        $imagePath = $product->image 
                            ...
                            : (isset($galleryImages) && count($galleryImages) > 0 
                                ? asset($galleryImages[($product->id + 5) % count($galleryImages)])
                                : 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=800');
                    @endphp
                    <div class="destination-card requires-auth" role="button" tabindex="0" data-href="#">
                        <img src="{{ $imagePath }}" alt="{{ $product->name }}" />
                        <div class="destination-overlay">
                            <div class="destination-title">{{ $product->name }}</div>
                            <div class="destination-info">
                                @if($product->vendor)
                                    <span>🏪 {{ $product->vendor->name }}</span>
                                @endif
                                <span class="destination-price">₱{{ number_format($product->price, 2) }}</span>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="empty-state" style="grid-column: 1/-1;">
                        ...
                        <p>Check back soon for amazing local products!</p>
                    </div>
                @endforelse
            </div>
    ...
    <div class="auth-modal" id="authModal">
        <div class="auth-modal-card">
            ...
            <div class="auth-modal-header">
                ...
                <p>Sign in to browse and purchase local products from Mansalay.</p>
            </div>
