...
<head>
    ...
    <title>Events & Festivals | Discover Mansalay</title>
...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('events.public') }}" style="color: var(--pink-600); font-weight: 600;">Events</a>
    ...
    <section class="destinations">
        <div class="destinations-container">
            ...
            <div class="section-header">
                <span class="section-tag">Events & Festivals</span>
            ...
            <div class="destinations-grid">
                @forelse($events as $event)
                    ...
                    @endphp
                    <div class="destination-card requires-auth" role="button" tabindex="0" data-href="{{ route('events.show', $event->id) }}">
                        <img src="{{ $imagePath }}" alt="{{ $event->name }}" />
                        <div class="destination-overlay">
                            <div class="destination-title">{{ $event->name }}</div>
                            <div class="destination-info">
                                <span>📅 {{ $event->start_date->format('M d, Y') }}</span>
                                <span>📍 {{ $event->location ?? 'Location TBA' }}</span>
                                @if($event->is_featured)
                                    <span class="destination-price">⭐ Featured</span>
                                @endif
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="empty-state" style="grid-column: 1/-1;">
                        ...
                        <p>Check back soon for exciting upcoming celebrations!</p>
                    </div>
                @endforelse
            </div>
    ...
    <div class="auth-modal" id="authModal">
        <div class="auth-modal-card">
            ...
            <div class="auth-modal-header">
                ...
                <p>Sign in to learn more about upcoming events and celebrations.</p>
            </div>
