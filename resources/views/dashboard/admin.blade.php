...
@if(isset($pendingVendorPayments) && $pendingVendorPayments > 0)
<!-- Pending Vendor Payments Alert -->
<div class="card" style="background: #e0f2fe; border-left: 4px solid #0ea5e9; margin-bottom: 1.5rem;">
    <div class="card-body" style="padding: 1rem 1.5rem; display: flex; justify-content: space-between; align-items: center;">
        <div style="display: flex; align-items: center; gap: 1rem;">
            <svg width="24" height="24" fill="none" stroke="#0369a1" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <div>
                <strong style="color: #0369a1;">{{ $pendingVendorPayments }} vendor payment(s) awaiting verification</strong>
                <p style="margin: 0; font-size: 0.85rem; color: #075985;">Review receipts before approving vendor accounts.</p>
            </div>
        </div>
        <a href="{{ route('users.index', ['approval' => 'pending']) }}" class="btn btn-primary" style="background: #0ea5e9; border-color: #0ea5e9;">
            Review Now
        </a>
    </div>
</div>
