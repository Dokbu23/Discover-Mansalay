...
<head>
    ...
    <title>Heritage Sites | Discover Mansalay</title>
...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('heritage.public') }}" style="color: var(--pink-600); font-weight: 600;">Heritage Sites</a>
        ...
        <div class="destinations-container">
            ...
            <div class="destinations-grid">
                @forelse($heritageSites as $site)
                    ...
                    @endphp
                    <div class="destination-card requires-auth" role="button" tabindex="0" data-href="{{ route('heritage.show', $site->id) }}">
                        <img src="{{ $imagePath }}" alt="{{ $site->name }}" />
                        <div class="destination-overlay">
                            <div class="destination-title">{{ $site->name }}</div>
                            <div class="destination-info">
                                <span>📍 {{ $site->location ?? 'Location TBA' }}</span>
                                @if($site->entrance_fee)
                                    <span class="destination-price">₱{{ number_format($site->entrance_fee, 2) }}</span>
                                @else
                                    <span class="destination-price">Free Entry</span>
                                @endif
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="empty-state" style="grid-column: 1/-1;">
                        ...
                        <div class="empty-state-title">No Heritage Sites Available</div>
                        <p>Check back soon for new cultural treasures!</p>
                    </div>
                @endforelse
            </div>
    ...
    <div class="auth-modal" id="authModal">
        <div class="auth-modal-card">
            ...
            <div class="auth-modal-header">
                ...
                <p>Sign in to explore heritage site details and learn more about our cultural treasures.</p>
            </div>
